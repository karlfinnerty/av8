...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Speed180", String.valueOf(IconChooser.speedToColour(180)));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.getUiSettings().setRotateGesturesEnabled(false); //Disable map rotation because it messes with plane and compass bearings
    ...
    public void showHelpDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage(
                        ...
                        "\nThe speed heat map ranges from high to low – pink to blue.\n" +
